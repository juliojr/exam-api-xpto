...
public class CityContoller {
	...
	public List<CitiesFileResponse> uploadMultipleFiles(@RequestParam("files") MultipartFile[] files) {
	...
	public ResponseEntity<Resource> downloadFile(@PathVariable String fileName, HttpServletRequest request) {
		...
		Resource resource = citiesFileService.loadFileAsResource(fileName);
