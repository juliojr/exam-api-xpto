...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        ApiInfo apiInfo = new ApiInfo("My REST API", "Some custom description of API.", "API TOS", "Terms of service", new Contact("Julio Souza", "www.example.com", "juliojr.souza@gmail.com"), "License of API", "API license URL", Collections.emptyList());
        return apiInfo;
    }
}