...
public class SwaggerConfig {
	@Bean
	public Docket apiCitiesXpto() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.xpto.cities.controller")).paths(PathSelectors.any())
	...
	private ApiInfo metaInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("Spring Boot Swagger Example API", "Spring Boot Swagger Example API for Youtube",
				...
				new Contact("Julio Souza", "https://github.com/juliojr", "juliojr.souza@gmail.com"),
